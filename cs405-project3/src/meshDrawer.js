 ...
 */
 class MeshDrawer {
	...
	draw(matrixMVP, matrixMV, matrixNormal, modelMatrix, viewPosition) {
		gl.useProgram(this.prog)

		// Set the view position uniform
        let viewPosLoc = gl.getUniformLocation(this.prog, 'viewPos');
        gl.uniform3fv(viewPosLoc, new Float32Array(viewPosition));
...
uniform vec3 viewPos; // Add this uniform for the camera/view position
...
void main()
{
    ...
    if (isLightSource) {
        ...
        vec3 lighting = (ambientStrength + diff + spec) * texColor.rgb;
